...
<header id="page-header">
    ...
    <ol class="breadcrumb">
        ...
        <li><a href="roomtable">เลือกห้องเรียน</a></li>
        <li class="active">ตารางการใช้ห้องเรียน</li>
    </ol>
</header>
<!--header-->
<!--MAIN STUDY SCHEDULE-->
            ...
            <div id="section-to-print">
                <div class="panel-heading">
                    <span class="title elipsis">
                        <strong>ตารางห้องเรียน ห้อง <b style="color: red"><?= $datail_room[0]['room_name'] ?></b>
                            ประจำปีการศึกษา <b style="color: red"><?= $year ?></b>
                            ภาคการศึกษา <b style="color: red"><?= $semester ?></b>
                             </strong>
                    </span>
                </div>
                <!--SHOW TEACH TABLE-->
                        ...
                        <table class="table table-striped table-bordered table-hover" id="datatable_sample"
                            ...
                            for ($i = 0; $i < 7; $i++) {
                                ...
                                <tr class="odd gradeX">
                                    ...
                                    for ($j = 0; $j < 24; $j++) {
                                        $save_row[0] = "";
                                        foreach ($Data_real_Room_show as $row) {
                                        ...
                                        if ($save_row[0] != null) {
                                            ...
                                            echo "<td id='" . $i . "$j" . "' colspan='" . $save_row[0]['timeslot_lenght'] . "'>" .
                                                $save_row[0]['subject_detail'][0]['subject_detail'][0]['subject_id'] . " " .
                                                $save_row[0]['subject_detail'][0]['subject_detail'][0]['subject_namethai'] . "<br>" . " (" . $save_section . ")" . "</td>";
